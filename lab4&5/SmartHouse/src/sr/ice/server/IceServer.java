...
//			ObjectAdapter adapter = communicator.createObjectAdapter("Adapter1");
			...
			CoffeeExpressI coffeeExpressServant = new CoffeeExpressI();
			AutomaticCoffeeExpressI automaticCoffeeExpress = new AutomaticCoffeeExpressI();
			SmartFridgeI smartFridge = new SmartFridgeI();

			// 4. Dodanie wpisów do tablicy ASM, skojarzenie nazwy obiektu (Identity) z serwantem
			adapter.add(coffeeExpressServant, new Identity("coffeeExpress", "smartHouse"));
			adapter.add(automaticCoffeeExpress, new Identity("automaticCoffeeExpress", "smartHouse"));
			adapter.add(smartFridge, new Identity("smartFridge", "smartHouse"));
